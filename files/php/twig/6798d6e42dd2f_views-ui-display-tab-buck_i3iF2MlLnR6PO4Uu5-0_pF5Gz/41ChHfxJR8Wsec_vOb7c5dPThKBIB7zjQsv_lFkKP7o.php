...
class __TwigTemplate_c5e29e094316afd91a28fa45d741ee652854bc1f0fced143336bdc508fdc414c extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    ";
            ...
            if (($context["title"] ?? null)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 31, $this->source), "html", null, true));
                echo "</h3>";
            }
            // line 33
            echo "    ";
            if (($context["actions"] ?? null)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["actions"] ?? null), 34, $this->source), "html", null, true));
                echo "</div>";
            }
            // line 36
            echo "    </div>
...
", "core/themes/claro/templates/views/views-ui-display-tab-bucket.html.twig", "/home/mizaramg/domains/miandrilala_group/core/themes/claro/templates/views/views-ui-display-tab-bucket.html.twig");
    }
