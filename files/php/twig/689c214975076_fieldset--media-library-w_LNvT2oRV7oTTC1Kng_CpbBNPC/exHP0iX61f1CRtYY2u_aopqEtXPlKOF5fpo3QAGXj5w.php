...
class __TwigTemplate_79ca5bdc93d5ee7a7c61f00c10a864490531b4958236440d0dd281908bbb4e0a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_media_library_prefix($__prefix__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["prefix"] ?? null), "empty_selection", [], "any", false, false, true, 13)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["prefix"] ?? null), 14, $this->source), "html", null, true));
                echo "</p>
  ";
            } else {
                // line 16
                echo "    ";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["prefix"] ?? null), 16, $this->source), "html", null, true));
                echo "
  ";
            }
...
%}
", "core/themes/claro/templates/media-library/fieldset--media-library-widget.html.twig", "/home/mizaramg/domains/miandrilala_group/core/themes/claro/templates/media-library/fieldset--media-library-widget.html.twig");
    }
